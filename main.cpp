...
void fixJournal() // Журнал всех исправлений
{
	...
	puts("Версия 1.0 BETA - Список изменений: \n"
		...
		"2. Обновлена функция N - 5 (III уровень) \n"
		"3. Обновлена функция N - 3 (III уровень) \n"
		"4. Обновлена функция Q - 2 (III уровень) \n"
		"5. Добавлены второстепенные функции, значительно укорачивающие код \n"
		"6. Исправление мелких ошибок \n"
		"7. Исправление серьёзных ошибок \n"
		"Отчёт обновлён 13.04.2018 в 17:00 \n\n"
...
void menuPick() // Выбор меню
{
	...
	do
	{
		if (prevIndex != index)
		{
			prevIndex = index;
			system("cls");
			puts("Версия программы: 1.3.0 RELEASE \n\n"
				"Здравствуйте!\n"
